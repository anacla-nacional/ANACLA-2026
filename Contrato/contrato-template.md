...
- b) Transferência de hospedagem para a plataforma indicada pelo CONTRATANTE;
- c) Configuração de domínio e certificado SSL;
- d) Treinamento básico para atualização de conteúdo.

---

## CLÁUSULA 2ª — VALORES E FORMA DE PAGAMENTO

2.1. Pelos serviços de desenvolvimento descritos na Cláusula 1ª, o CONTRATANTE pagará ao CONTRATADO o valor de **R$ _____,_____ (_______ reais)**, pagamento único, devido na entrega do site funcionando.

2.2. Pelo serviço de manutenção mensal, o CONTRATANTE pagará ao CONTRATADO o valor de **R$ _____,_____ (_______ reais)** por mês, devido até o ___º dia útil de cada mês.

2.3. Os pagamentos deverão ser efetuados via PIX, transferência bancária ou boleto, mediante emissão de recibo pelo CONTRATADO.

2.4. Em caso de atraso no pagamento da manutenção mensal, incidirá multa de 2% sobre o valor devido, acrescido de juros de 1% ao mês, calculados pro rata die.

---

## CLÁUSULA 3ª — PRAZO DE ENTREGA

3.1. O site deverá ser entregue no prazo de **___ (_____) dias corridos**, contados a partir da assinatura do presente contrato e fornecimento de todo o material necessário (textos, imagens, logos) pelo CONTRATANTE.
...
4.1. O serviço de manutenção mensal inclui:

- a) Suporte técnico para correção de bugs e falhas;
- b) Atualizações de segurança do site;
- c) Monitoramento da disponibilidade do site;
- d) Pequenas alterações de conteúdo (textos, imagens, links);
- e) Backup mensal do site.
...
6.1. A hospedagem do site será realizada em plataforma gratuita (GitHub Pages) ou outra plataforma indicada pelo CONTRATANTE.

6.2. O custo do registro de domínio (ex.: .com.br, .com, .pt) é de responsabilidade do CONTRATANTE.

6.3. O CONTRATADO auxiliará na configuração inicial da hospedagem e apontamento do domínio, sem custo adicional.

6.4. Após a configuração inicial, a gestão da hospedagem é de responsabilidade do CONTRATANTE.
...
7.2. Qualquer das partes poderá rescindir o contrato, mediante comunicação por escrito com antecedência mínima de **___ (_____) dias**.
...
- d) Manter o registro de domínio e hospedagem ativos;
...
10.2. Não sendo possível a resolução amigável, fica eleito o foro da Comarca de **[CIDADE/UF]**, com renúncia a qualquer outro, por mais privilegiado que seja.
...
**[CIDADE/UF], ___ de _____________ de ________.**
...
*Contrato de Prestação de Serviços — Modelo para referência*
